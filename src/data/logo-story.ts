  ...
  steps: [
    {
      id: "main-ring",
      title: "文明圓環",
      subtitle: "Main Circular Emblem",
      text: "徽識中心的圓環象徵延續、和諧與人類共同的文明承傳，代表傳統文化作為連結世代與民族的生命智慧。",
    },
    {
      id: "opera",
      title: "戲曲藝術",
    ...
    },
    {
      id: "complete",
      title: "完整徽識",
      subtitle: "Complete Emblem",
      text: "這些文化形態匯聚在一起，呈現基金會的使命：保存、傳承並更新傳統文化，使其成為教育、對話與和平的活態力量。",
    },
  ],
};
