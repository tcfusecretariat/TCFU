...
const categoryImages: Record<LogoStoryStepId, string> = {
  "dance-literature": "/assets/logo-story/literature-classics.png",
  penmanship: "/assets/logo-story/performing-arts.png",
  architecture: "/assets/logo-story/architecture-spatial-culture.png",
  music: "/assets/logo-story/music-harmony.png",
  "culinary-culture": "/assets/logo-story/culinary-culture.png",
  "ritual-arts": "/assets/logo-story/ritual-arts.png",
  opera: "/assets/logo-story/traditional-opera.png",
};
  ...
  steps: [
    {
      ...
      image: categoryImages["dance-literature"],
    },
    {
      id: "penmanship",
      ...
      image: categoryImages.penmanship,
    },
    {
      id: "architecture",
    ...
    },
    {
      ...
      image: categoryImages["culinary-culture"],
    },
    {
      id: "ritual-arts",
      title: "Ritual Arts",
      ...
      image: categoryImages["ritual-arts"],
    },
    {
      id: "opera",
...
const logoStoryZh: LogoStoryContent = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "音樂",
      subtitle: "Music",
      text: "音樂是超越語言邊界的文化表達。節奏、旋律與聲音的共鳴，能夠喚起人類共同的情感經驗，使不同文化在聆聽之中相遇。傳統音樂不僅保存了地方記憶與審美形式，也體現了人們對和諧、秩序與內在平衡的追求。它提醒我們，文化交流並不僅依賴語言，也可以通過聲音與心靈的共振而展開。",
      image: categoryImages.music,
    },
    {
      id: "culinary-culture",
